function  [uc, ducdu] = satUR5_2(u, par, Delta_u)
%satUR5_2 Generates saturated (clipped) input UC
%
% [UC DUCDU] = satUR5_2(U, PAR, Delta_u) Calculates the saturation of an input scalar U
