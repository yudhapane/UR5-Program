...
params.NrbfXa    = 30;                       % no of rbfs in q dimension for the actor
...
params.theta    = zeros(params.NrbfXc*params.NrbfYc,1); 	% critic parameters
...
params.Bc    = [5e-07 0; 0 1e-07];           	% the rbf's variance
...
params.Ba    = [1e-06 0; 0 1e-06];           	% the rbf's variance
...
% Learning parameters
params.alpha_a1 = 0.5e-06;                    % actor learning rate
params.alpha_a2 = 0.003;                     % actor learning rate
params.alpha_c1 = 0.1;                      % critic learning rate
params.alpha_c2 = 0.1;                      % critic learning rate
