...
params.zulim        = 0.35;                     % upper limit of the state space
...
% Other RL parameters
params.Q        = [1e3 0; 0 1e3];          	% the error cost function penalty
params.R        = 1e-7;                     % the actor input cost function penalty
