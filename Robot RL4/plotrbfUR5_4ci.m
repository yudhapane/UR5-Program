function y = plotrbfUR5_4ci(par, opt, opt2)
%plotrbfUR5_4ci plot the radial basis functions-based approximated actor or 
%             critic function for the UR5 robot individually. Useful for
%             tuning the rbf parameters
%
%   y = plotrbfUR5_4ci(par, opt) plot a rbf-based approximated function
...
% last updated on : Jun-17-2015	
	...
	x2  = linspace(par.rmin, par.rmax, N);
