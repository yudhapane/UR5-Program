%robotRLTest4b is a script to test the RL-based additive reference modifier to 
...
% the approximator. This is the second version which uses tracking errors
% as the state instead of the positions.
% 
...
for trial_count = 0:par.Ntrial
    ...
    [wrTraj2, wdrTraj2, time, N]	= genTraj(5, par, arm);  % generate trajectory
