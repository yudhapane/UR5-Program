function sf_urarm_movejoint(block)
% sf_urarm_movejoint, a level-2 s-function for moving the joints of the ur
% arm
%
...
urarm.moveJoints(pos,speed,acc,time,blend_radius);
