...
if strcmp(par.plotSelect,'1')
    ...
    xlabel('$y \hspace{1mm}$ [mm]','Interpreter','Latex'); ylabel('$x \hspace{1mm}$ [mm]','Interpreter','Latex'); zlabel('$\pi(w)$ \hspace{1mm} [-]','Interpreter','Latex'); %colorbar 
    ...
    positionVector5 = [0.55, 0.42, 0.43, 0.43];
