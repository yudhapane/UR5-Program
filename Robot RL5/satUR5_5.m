function  [uc, ducdu] = satUR5_4(u, par, Delta_u)
%SATUR5_4 Generates saturated (clipped) additive modifier to the reference
%
% [UC DUCDU] = satUR5_4(U, PAR, Delta_u) Calculates the saturation of an input scalar U
...
%           perturbed input u.
% 
% original author   : Subramanya P. Nageshrao
% edited by         : Yudha Prawira Pane 
