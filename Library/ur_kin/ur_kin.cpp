...
int main(int argc, char* argv[])
{
  ...
  double q[6] = {-0.192467514845901, -1.848296283003041, 2.069337788279298, -0.220599668026455, 1.378778843626511, 3.141592653731492};
  //double* T = new double[16];
  double T[16] = {0.999977458977064, -0.006102304800739,0.002800609557433, -0.393527189562514,0.006585792524228,0.972652586957697,-0.232171428951385,-0.081397597507710,-0.001307239305611,0.232184639803367,0.972670850886763,0.599838769738627,0,0,0,1};
//  forward(q, T);
  for(int i=0;i<4;i++) {
